...
CLANG="${CLANG:-${IREE_BUILD_DIR}/third_party/llvm-project/llvm/bin/clang}"
# TODO(benvanik): figure out how to get this path from clang itself.
CLANG_INCLUDE="${CLANG_INCLUDE:-${IREE_BUILD_DIR}/third_party/llvm-project/llvm/lib/clang/17/include/}"
